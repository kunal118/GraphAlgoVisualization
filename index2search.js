...
function bfs1(startPoint, endPoint) {
...
/////////////////////////////////////
  ...
  function comp() {
    ...
    if ($(".box"+conv(start)).hasClass("areaSearch2")) {
      end = conv(end);
      endReached = true;
      return pathf();
    }
...
//comp();
  ...
  $(".box" + end).removeClass("areaSearch").removeClass("areaSearch2").addClass("path");
    end = head[end];
  //  console.log(end);
    setTimeout(function() {
...
function bfs2(endPoint, startPoint) {
...
/////////////////////////////////////
  ...
  function comp() {
    ...
    if ($(".box"+conv(start)).hasClass("areaSearch")) {
      end = conv(end);
      endReached = true;
      return pathf();
    }
    ...
    $(".box" + conv(start)).addClass("areaSearch2");
...
//comp();
  ...
  $(".box" + end).removeClass("areaSearch2").removeClass("areaSearch").addClass("path");
    end = head[end];
  //  console.log(end);
    setTimeout(function() {
...
$(".button1").on("click", () => {
  bfs1(startPoint, endPoint);
  bfs2(startPoint, endPoint);
